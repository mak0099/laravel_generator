    ...
    <div class="modal-dialog">
        <form action="{{ route('news.index') }}">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Date</label>
                    <input name="date" class="form-control" type="text" value="{{ optional($news->date)->format(config('dashboard.input_date_format')) }}" readonly>
                </div>
                <div class="form-group">
                    @if($news->image_path)
                    <label>Image</label>
                    <div>
                        <img src="{{ asset($news->image_path) }}" alt="image" style="height: auto; max-width: 100%; border: 2px solid #ddd; margin: 2px 0;">
                    </div>
                    @endif
                </div>
                <div class="row">
